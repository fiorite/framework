...
export function FromQuery<R>(transform: MapCallback<HttpQuery, R>): ProvideDecorator<HttpContext, MaybePromiseLike<R>>;
...
export function FromHeader<R>(transform: MapCallback<HttpHeaders, R>): ProvideDecorator<HttpContext, MaybePromiseLike<R>>;
...
export function FromBody<T, R>(transform: MapCallback<T | undefined, MaybePromiseLike<R>>): ProvideDecorator<HttpBodyResult<T>, MaybePromiseLike<R>>;
