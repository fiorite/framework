...
import { DbPrimitiveValue } from '../db/query';

export function buildSqlite3Where(model: DbModel, iterable: Iterable<DbWhere>): { sql: string, params: Record<string, unknown> } {
  let counter = 0;
  const pieces: string[] = [];
